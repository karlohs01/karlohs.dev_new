    ...
    <section id="about" className="py-24 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center gap-3 mb-12">
          <span className="font-mono text-terminal-blue text-sm">01.</span>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            <div className="bg-card border border-border rounded-lg p-6 hover:border-terminal-blue/50 transition-colors">
              <div className="flex items-start gap-4">
                <div className="p-2 bg-terminal-blue/10 rounded">
                  <GraduationCap className="w-5 h-5 text-terminal-blue" />
                </div>
                <div>
                  ...
                  <p className="text-sm text-terminal-blue font-mono mt-1">GPA: 3.03/4.0</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-card border border-border rounded-lg p-6 hover:border-terminal-blue/50 transition-colors">
              <div className="flex items-start gap-4">
                <div className="p-2 bg-terminal-blue/10 rounded">
                  <Award className="w-5 h-5 text-terminal-blue" />
                </div>
                <div>
